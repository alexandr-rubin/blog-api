  ...
  "swaggerDoc": {
    ...
    "paths": {
      ...
      "/sa/blogs": {
        ...
        "post": {
          "operationId": "SuperAdminBlogsController_createBlog",
          "parameters": [],
          "requestBody": {
            "required": true,
            "content": {
      ...
      "/sa/blogs/comments": {
        "get": {
          "operationId": "SuperAdminBlogsController_getComments",
          "parameters": [],
          "responses": {
            "200": {
              "description": ""
      ...
      "/sa/blogs/{blogId}/posts": {
        "post": {
          "operationId": "SuperAdminBlogsController_createPostForSecificBlog",
          "parameters": [
            {
              "name": "blogId",
              "required": true,
        ...
        "get": {
          "operationId": "SuperAdminBlogsController_getPostsForSpecifyBlog",
          "parameters": [
            {
              "name": "blogId",
              "required": true,
      ...
      "/sa/blogs/{blogId}": {
        "delete": {
          "operationId": "SuperAdminBlogsController_deleteBlogById",
          "parameters": [
            {
              "name": "blogId",
              "required": true,
        ...
        "put": {
          "operationId": "SuperAdminBlogsController_updateBlogById",
          "parameters": [
            {
              "name": "blogId",
              "required": true,
      ...
      "/sa/blogs/{blogId}/posts/{postId}": {
        "put": {
          "operationId": "SuperAdminBlogsController_updatePostById",
          "parameters": [
            {
              "name": "blogId",
              "required": true,
        ...
        "delete": {
          "operationId": "SuperAdminBlogsController_deletePostForSpecifyBlog",
          "parameters": [
            {
              "name": "blogId",
              "required": true,
